...
all_infalling_objects = ('/run/media/ppxrh2/166AA4B87A2DD3B7/MergerTreeAHF/'
        ...
        + 'NewMDCLUSTER_0002_reruns/')
all_infalling_branches = all_infalling_objects
all_infalling_bounded = all_infalling_objects
all_grp_member_branches = all_infalling_objects
all_grp_member_data = all_infalling_objects
all_relative_clus_data = all_infalling_objects

halo_data = (all_infalling_objects + 'reduced_cluster_info/')
cluster_halo_data = (all_infalling_objects + 'cluster_halo_data/')
backsplash_track_data = (all_infalling_objects + 'full_tracking/')
main_prog_data = (all_infalling_objects + 'main_progs/')
ascii_prog_data = all_infalling_objects
